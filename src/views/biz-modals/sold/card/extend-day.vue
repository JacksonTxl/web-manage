<template>
  <st-modal
    ...
    size="small"
    v-model="show"
    wrapClassName="modal-sold-card-extend-day"
  >
...
export default {
  ...
  rxState() {
    return {
      list_num: this.extendDayService.list_num$,
      loading: this.extendDayService.loading$
    }
  },
  props: {
    ids: {
  ...
  mounted() {
    this.extendDayService.getRenewalCount(this.searchQuery).subscribe()
  },
  data() {
