  ...
  <a-modal title="更改员工职位" @ok="onSubmit" size="small" v-model="show">
    ...
    <st-form labelWidth="66px" :form="form">
      <st-form-item label="工作性质">
        ...
        <a-select placeholder="请选择" v-decorator="['nature_work' ,{ initialValue: 1 }]">
      ...
      <st-form-item label="员工职能">
        ...
        <a-select mode="multiple" placeholder="请选择" @change="onChange" v-decorator="['identity', { initialValue: [1,2] }]">
          <template v-if="enums.nature_work">
