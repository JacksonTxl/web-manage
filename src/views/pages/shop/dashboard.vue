    ...
    <a-col :class="bCount()" :lg="18">
      ...
      <st-panel class="mg-t16" >
        ...
        <a-row>
          <a-col :span="14">
            <st-t3> 营收趋势</st-t3>
            <shop-revenue-line :data="data4"></shop-revenue-line>
          </a-col>
          <a-col :span="10">
            <st-t3>营收结构</st-t3>
            <shop-revenue-ring :data="data3"></shop-revenue-ring>
      ...
      <st-panel class="mg-t16" >
        ...
        <a-row>
          ...
          <a-col :span="17">
            <st-t3>新增入会用户</st-t3>
            <shop-add-user  :data="data8"></shop-add-user>
          </a-col>
        </a-row>
      </st-panel>
      <st-panel class="mg-t16" >
