                          ...
                          <td colspan="6">
                            ...
                            v-decorator="['teamCourseList2']">
                                ...
                                :key="i.course_id">
                                  ...
                                  <div>{{i.team_times*i.team_unit_price}}</div>
                                </li>
                            </ul>
                          </td>
                        </tr>
                                ...
                                :key="item.course_id">
                                  ...
                                  <div>
                                    <a-dropdown placement="bottomRight">
                                      <a href="javascript:void(0)">教练等级范围&nbsp;&nbsp;<st-icon class="icon-12" type="down-small" /></a>
                                      <!-- 在AForm组件里用自定义指令时，需要加上v-decorator,值不能重复 -->
                                  ...
                                  <div>{{item.personal_times*item.personal_unit_price}}</div>
                                </li>
                            </ul>
                          </td>
                        </tr>
