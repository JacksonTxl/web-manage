<template>
  <section :class="basic()">
    ...
    <st-panel initial class="mgt-12"
      :tabs="[
        { label: '消费记录', route: { name: 'shop-sold-card-info-deposite-info-consumption-record', query: {id:infoService.cardId} } },
        { label: '操作日志', route: { name: 'shop-sold-card-info-deposite-info-operation-record', query: {id:infoService.cardId} } },
      ]"
    >
...
export default {
  name: 'PageShopSoldCardDepositeInfo',
  bem: {
