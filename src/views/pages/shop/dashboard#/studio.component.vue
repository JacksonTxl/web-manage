<template>
  <a-row :class="b()" :gutter="24">
    <a-col :class="bCount()" :lg="18">
      <st-panel title="概况">
        <div slot="actions">
          最近更新时间：2019-04-02 12:38  <st-icon type="switch"></st-icon>
        </div>
        ...
        <a-row class="mg-t24 count1">
          <a-col :class="bCount('date')" :lg="3">
            今日
          </a-col>
          <a-col :class="bCount('count')" :lg="5">
            {{buyCourseNum.today}}
           </a-col>
          <a-col :class="bCount('count')" :lg="5">
            {{revenueAmount.today}}
        ...
        <a-row class="mg-t32 count3">
          ...
          <a-col :class="bCount('count')" :lg="5">
            {{buyCourseNum.nearly_seven_days}}
          </a-col>
          <a-col :class="bCount('count')" :lg="5">
        ...
        <a-row class="mg-t32 count4">
          ...
          <a-col :class="bCount('count')" :lg="5">
            {{buyCourseNum.nearly_thirty_days}}
          </a-col>
          <a-col :class="bCount('count')" :lg="5">
      ...
      <st-panel class="mg-t16" >
        ...
        <a-row>
          <a-col :span="7">
            <st-t3>营销漏斗</st-t3>
            <funnel-vertical :data="member.member"></funnel-vertical>
          </a-col>
          <a-col :span="17">
            <st-t3>新增入会用户</st-t3>
            <shop-add-user  :data="buyCourse"></shop-add-user>
          </a-col>
        </a-row>
      </st-panel>
      <st-panel class="mg-t16" >
      ...
      <st-panel class="mg-t16" >
        ...
        <a-row>
          <a-col :span="14">
            <st-t3>入场人数</st-t3>
            <shop-entry-line v-if="show" :data="inoutNum"></shop-entry-line>
          </a-col>
          <a-col :span="10">
            <st-t3>入场人数横向柱状图</st-t3>
...
import { StudioComponentService } from './studio.component.service'
export default {
  name: 'ClubComponent',
  bem: {
    b: 'page-shop-dashboard-club',
    bCount: 'page-shop-dashboard-count',
    bAdv: 'page-shop-dashboard-adv'
  },
  serviceInject() {
    return {
  ...
  rxState() {
    return {
      ...
      buyCourse: this.studioComponentService.buyCourse$
    }
  },
  computed: {
    revenueAmount() {
