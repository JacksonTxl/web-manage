<template>
  <st-panel
        :tabs="[
          { label: '私教设置', route: { name: 'brand-setting-app-personal' } },
          { label: '团课设置', route: { name: 'brand-setting-app-team' } }
        ]"
      >
        <!-- 团课定价设置 -->
        <a-row>
          ...
          <a-col :span="8" class="ta-r">
            <modal-link tag="a" :to="{ name:'brand-setting-team-reserve' }">编辑</modal-link>
          </a-col>
        </a-row>
        <!-- 预约范围 -->
