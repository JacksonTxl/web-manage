  ...
  <div :class="bPage()">
    ...
    >
      ...
      <div slot="action" slot-scope="text, record">
        <st-table-actions>
          <a
            v-if="record.auth['brand_shop:flow:inform|reverse']"
...
import { IncomeService } from './inform.service'
import { columns, totalColumns } from './inform.config.ts'
