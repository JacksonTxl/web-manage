  ...
  <div :class="bPage()">
    ...
    >
      ...
      <div slot="action" slot-scope="text, record">
        <st-table-actions>
          <a
            v-if="record.auth['brand_shop:flow:notice|reverse']"
...
import { IncomeService } from './notice.service'
import { columns, totalColumns } from './notice.config.ts'
