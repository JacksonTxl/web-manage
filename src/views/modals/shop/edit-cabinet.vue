      ...
      <a-row>
        <a-col :xs="22">
          <st-form-item label="区域">
            <a-input value="xxx区域" disabled/>
          </st-form-item>
          <st-form-item label="储物柜类型" required>
            <a-select placeholder="请选择储物柜类型">
              <a-select-option value="a">A</a-select-option>
            </a-select>
          </st-form-item>
          <st-form-item label="首字母">
            <a-input placeholder="请输入首字母"/>
          </st-form-item>
          <st-form-item label="起始编号" required>
            <a-input placeholder="请输入起始编号"/>
          </st-form-item>
          ...
          <st-form-item label="价格" required>
            <st-input-number placeholder="请输入售卖价格">
              <template slot="addonAfter">元/天</template>
            </st-input-number>
          </st-form-item>
          <st-form-item label="转让手续费" required>
            <st-input-number placeholder="请输入转让手续费">
