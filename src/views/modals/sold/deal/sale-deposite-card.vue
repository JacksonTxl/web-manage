  ...
  wrapClassName="modal-sold-deal-sale">
    <div :class="sale('content')">
      <a-row :class="sale('info')">
        <a-col :span="13">
          <st-info>
            ...
            <st-info-item label="消费类目">{{info.consume}}</st-info-item>
            <st-info-item class="mg-b24" label="有效时间">{{info.num}}</st-info-item>
          </st-info>
        </a-col>
        <a-col :span="11">
           <st-info>
      ...
      <st-form labelWidth="72px">
        <div :class="sale('sale')">
          <st-form-item v-show="searchMemberIsShow" label="购买会员" required labelGutter="12px">
            <a-select
              showSearch
              allowClear
