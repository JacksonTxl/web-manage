      ...
      <st-form :form="form" labelWidth="56px">
        ...
        <st-form-item label="预约范围">
          <div>
            ...
            <a-select class="mg-l8" style="width: 100px">
              <a-select-option value="3">3小时后</a-select-option>
            </a-select>
            <span class="mg-l8" >到</span>
            <a-select class="mg-l8" style="width: 66px">
              <a-select-option value="3">1周</a-select-option>
            </a-select>
        ...
        <st-form-item label="取消预约">
          <div>
            ...
            <a-select class="mg-l8" style="width: 84px">
        ...
        <!-- 预约上限 -->
        <st-form-item label="预约上限">
          <div>
            <span>允许用户每节课预约</span>
            <a-select class="mg-l8" style="width: 84px">
              <a-select-option value="1">1人</a-select-option>
            </a-select>
            <a-checkbox :checked="true" class="mg-l24">限制用户预约</a-checkbox>
            <a-input style="width: 66px"></a-input>
            <span class="mg-l8" >节未开课的团体课程</span>
          </div>
        </st-form-item>
        <!-- 侯补预约 -->
        <st-form-item label="侯补预约">
          <a-checkbox :checked="true">支持未开课课程侯补预约</a-checkbox>
          <div class="st-des">当报名用户取消预约时，自动按候补顺序为用户进行补位预约</div>
        </st-form-item>
        <!-- 签到方式 -->
        <st-form-item label="签到方式">
          <a-checkbox :checked="true">支持用户自主签到</a-checkbox>
        </st-form-item>
        <!-- 签到时间 -->
        <st-form-item label="签到时间">
          <div>
            <span>开课</span>
            <a-select class="mg-l8" style="width: 120px">
        ...
        <st-form-item label="爽约惩罚">
          <div><a-checkbox :checked="true">开启爽约惩罚</a-checkbox></div>
          <div class="mg-t8">
            <a-input style="width: 66px"></a-input>
            <span class="mg-l8">天内，已结束的团体课程未签到的课程数超过</span>
            <a-input class="mg-l8" style="width: 66px"></a-input>
